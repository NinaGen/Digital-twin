...
public class UDPManager : MonoBehaviour
{
    ...
    [SerializeField] private float angleSliderValue;
    ...
    void Update()
    {
        ...
        {
            SendSliderValue(angleSliderValue);
            //SendUDPMessage("LED|" + sliderValue , "10.126.128.82", 3002);
        }

        if (Input.GetKeyDown(KeyCode.DownArrow))
        {
            SendUDPMessage("LED|0", "10.126.128.82", 3002);
        }
    }

    public void SendSliderValue(float sliderValue)
    {
        SendUDPMessage("LED|" + sliderValue, "10.126.128.82", 3002);
    }
